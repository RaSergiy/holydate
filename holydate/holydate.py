...
class AncientCalendar:
    ...
    def getWeekdayname(self):
        ...
        #Марьино стояние меняется с Благовещением.
            ...
            self.weekdayname = '{red}{tw} Вознесение Господне.{end}'
    ...
    def getBow(self):
        ...
        #Устав о приходных и исходных поклонах всего лета.
        ...
        self.bows_word = {
            ...
            6: ('Утром, на службе приходные поклоны земные, исходные поясные; '
                'а вечером — приходные и исходные поясные.')
